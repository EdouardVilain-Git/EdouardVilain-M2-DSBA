create table campaign_cluster
as
(select campaign_cluster_actions.campaign_id, nb_sollicitations, nb_messages, action_month, action_week, nb_actions,
...
from
(select campaign_id, count(contact_id) as nb_sollicitations, count(distinct message_id) as nb_messages, 
